...
<div id="content">
	...
	<ul id="submenu">
		...
		echo '<li>' . '<a href="' . get_bloginfo('url') . '/?types='.$term->slug.'&cities='.$tax_term->slug.'" title="' . sprintf( __( "View all posts in %s" ), $tax_term->name ) . '" ' . 'class="'.$class.'">' . $tax_term->name.'</a></li>';
		} 
